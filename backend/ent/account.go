...
type AccountEdges struct {
	...
	UserBindings []*AccountUserBinding `json:"user_bindings,omitempty"`
...
// was not loaded in eager-loading.
func (e AccountEdges) UserBindingsOrErr() ([]*AccountUserBinding, error) {
	if e.loadedTypes[5] {
...
// QueryUserBindings queries the "user_bindings" edge of the Account entity.
func (_m *Account) QueryUserBindings() *AccountUserBindingQuery {
	return NewAccountClient(_m.config).QueryUserBindings(_m)
}
